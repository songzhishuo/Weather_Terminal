...
void MyWifi::wifi_connect(const char* ssid, const char * password)
{
...
int MyWifi::get_http_data(String &response)
{
    int ret = 0;
...
//天气数据解析
void MyWifi::json_data_analyze(String http_data,ALL_WEATHER_DATA_T *weather_data)
{
...
//解析周数据
WEAK_DAY_E MyWifi::weakday_data_analyze(char * weakday_data)
{
...
//天气数据解析
WEATHER_E MyWifi::weather_data_analyze(char *weather_data)
{
    char weather_enum = 0;
